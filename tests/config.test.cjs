...
test('toate cele șase pagini folosesc ?v=20260820 pentru css/style.css și js/main.js (M5)', () => {
  for (const pagina of PAGINI) {
    const html = fs.readFileSync(path.join(__dirname, '..', pagina), 'utf8');
    assert.ok(html.includes('css/style.css?v=20260820'), `${pagina}: css/style.css nu e la v=20260820`);
    assert.ok(html.includes('js/main.js?v=20260820'), `${pagina}: js/main.js nu e la v=20260820`);
  }
});
